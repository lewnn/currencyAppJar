...
public class JdbcLookupOptions implements Serializable {
    ...
    private final String lookUpDataFilter;

    public JdbcLookupOptions(long cacheMaxSize, long cacheExpireMs, int maxRetryTimes, String lookUpDataFilter) {
        this.cacheMaxSize = cacheMaxSize;
        this.cacheExpireMs = cacheExpireMs;
        this.maxRetryTimes = maxRetryTimes;
        this.lookUpDataFilter = lookUpDataFilter;
    }
    ...
    public String[] getPreFilterCondition() {
        if(lookUpDataFilter == null || lookUpDataFilter.isEmpty()){
            return new String[0];
        }
        String [] res = new String[1];
        res[0] = lookUpDataFilter.replace("\"", "'");
        return res;
    }
    ...
    public static class Builder {
        ...
        private String lookUpDataFilter = "";
        ...
        public JdbcLookupOptions build() {
            return new JdbcLookupOptions(cacheMaxSize, cacheExpireMs, maxRetryTimes, lookUpDataFilter);
        }
    }
}
