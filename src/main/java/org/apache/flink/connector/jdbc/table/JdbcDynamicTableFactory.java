...
public class JdbcDynamicTableFactory implements DynamicTableSourceFactory, DynamicTableSinkFactory {
    ...
    private static final ConfigOption<String> LOOKUP_DATA_FILTER =
            ConfigOptions.key("lookup.data.filter")
                    .stringType()
                    .noDefaultValue()
                    .withDescription(
                            "THE BASIC SELECT FILTER. "
                                    + "If  set, it will added after where");
    ...
    private JdbcLookupOptions getJdbcLookupOptions(ReadableConfig readableConfig) {
        return new JdbcLookupOptions(
                ...
                readableConfig.get(LOOKUP_DATA_FILTER));
    }
    ...
    public Set<ConfigOption<?>> optionalOptions() {
        ...
        optionalOptions.add(LOOKUP_DATA_FILTER);
